...
[![PyPI - Downloads](https://img.shields.io/pypi/dm/git-search-command?label=Downloads&logo=pypi&logoColor=white&color=ff69b4)](https://pypi.org/project/git-search-command/)
...
[![Coverage](https://img.shields.io/codecov/c/github/jamesnguyen46/git-search-command?token=HO0BAT95VI&label=Coverage&logo=codecov&logoColor=white&color=blueviolet)](https://codecov.io/gh/jamesnguyen46/git-search-command)
